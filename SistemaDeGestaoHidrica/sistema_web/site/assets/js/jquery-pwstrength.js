 ...
 *
 *   Edited by por Victor Queiroga. PT-BR language and Support for new CSS classes.
 */
(function($) {
    "use strict";
    ...
    var options = {
        ...
        minChar: 8,
        errorMessages: {
            password_to_short: "A senha é muito curta",
            same_as_username: "Sua senha não deve coincidir com o login"
        },
        scores: [17, 26, 40, 50],
...
//            progressbar.addClass("progress-danger").removeClass("progress-warning").removeClass("progress-success");
            $(".progress-bar").addClass("progress-bar-danger").removeClass("progress-bar-warning").removeClass("progress-bar-success");
...
//            progressbar.addClass("progress-warning").removeClass("progress-danger").removeClass("progress-bar-success");
            $(".progress-bar").addClass("progress-bar-warning").removeClass("progress-bar-danger").removeClass("progress-bar-success");
